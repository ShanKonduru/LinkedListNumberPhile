...
namespace LinkedListNumber {
    public static class BinaryTreePrinter {
        ...
        public static void PrintMe (this BinaryTreeNode root, string textFormat = "0", int spacing = 1, int topMargin = 2, int leftMargin = 2) {
            if (root == null) return;
        ...
        private static void PrintNode (string s, int top, int left, int right = -1) {
